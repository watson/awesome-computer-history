...
- [Politics on the Web](https://archive.org/details/nc103_cyberpolitics) (1990) Institute for Global Communications web site which includes links to PeaceNet, EcoNet, ConflictNet, LaborNet, and WomensNet. Eric Hughes, founder of Cypherpunks, a group working to preserve privacy on the net through encryption, explains the Cypherpunks Manifesto. Jory Bell demonstrates the Anarchists Press web site, akpress.org. Shot on location at the CyberSmith internet cafe in Palo Alto, California. Hosts are Jane Wither, Andrew deVries, and Stewart Cheifet. 28m.
